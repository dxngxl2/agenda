<x-layouts.guest>
    <form method="POST" action="{{ route('password.store') }}">
        ...
        <div>
            ...
            <x-profile.text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email', $request->email)" required autofocus />
        ...
        <div class="mt-4">
            ...
            <x-profile.text-input id="password" class="block mt-1 w-full" type="password" name="password" required />
